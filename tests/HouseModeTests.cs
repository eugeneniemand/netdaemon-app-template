...
//    {
//        MockState.Add(new EntityState { EntityId = "sensor.template_last_motion", State = "Landing Motion" });
//        MockState.Add(new EntityState { EntityId = "input_select.house_mode", State     = "morning" });

//        var app = new HouseModeImplementation(Object, TestScheduler);
//        app.Initialize();

//        TestScheduler.AdvanceTo("07:59:59");
...
//    {
//        MockState.Add(new EntityState { EntityId = "sensor.template_last_motion", State = "Landing Motion" });
//        MockState.Add(new EntityState { EntityId = "input_select.house_mode", State     = "day" });

//        var app = new HouseModeImplementation(Object, TestScheduler);
//        app.Initialize();

//        TestScheduler.AdvanceTo("19:59:59");
//        TriggerStateChange("sensor.template_last_motion", "Master Motion", "Landing Motion");
//        VerifyState("input_select.house_mode", "day");
...
//    {
//        MockState.Add(new EntityState { EntityId = "sensor.template_last_motion", State = "Landing Motion" });
//        MockState.Add(new EntityState { EntityId = "input_select.house_mode", State     = "night" });
...
//        TestScheduler.AdvanceTo("20:00:00");
