...
//{
//    public static LightManager InitLightManager(this AppTestContext ctx, LightsConfiguration config) => new LightManager(ctx.HaContext, new FakeAppConfig<LightsConfiguration>(config));
//}
